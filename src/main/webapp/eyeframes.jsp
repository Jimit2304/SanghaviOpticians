                            ...
                            <div class="filters mb-4" id="filterSection">
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" name="category" value="Sun Glass"
                                        id="Sun Glass">
                                    <label class="form-check-label" for="contactLenses">Sun Glass</label>
                                </div>
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" name="style" value="Cat Eye"
                                        id="catEye">
                                ...
                                <button type="reset" class="filter-btn mt-2"
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12">
                        <div class="row g-4">
                            <% Connection conn=null; PreparedStatement ps=null; ResultSet rs=null; try {
                                ...
                                StringBuilder sql=new StringBuilder("SELECT * FROM products WHERE category='Eye Frames'");
